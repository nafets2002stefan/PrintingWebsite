        ...
        <section className='container mx-auto flex flex-col md:flex-row justify between pt-44 pb-6 px-4 sm:px-6 lg:px-8'>
            ...
            <div className='w-full md:w-1/2 space-y-8'>
                ...
                <div className='flex items-center gap-2 bg-gray-50 w-fit px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group'>
                    <span className='text-blue-600 group-hover:scale-110 group-hover:text-amber-300 transition-transform'> ★</span>
                ...
                <p className='text-gray-600 text-lg md:text-xl max-w-xl'>
                    Get the most accurate leads, sales people training and convertions, tools and more - all within the same one billing.
                </p>
                {/* email section */}
