...
function Envelope() {
  return (
    <div className='flex flex-wrap justify-evenly gap-9 p-1 text-center ml-10'>
        ...
        <div className="h-[63px] w-[130px] bg-gray-300 flex items-center justify-center">130x63</div>
        <div className="h-[67px] w-[127px] bg-gray-300 flex items-center justify-center">127x67</div>
    </div>
  )
}
